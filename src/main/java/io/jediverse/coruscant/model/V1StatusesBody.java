...
public class V1StatusesBody   {
  ...
  public V1StatusesBody status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public V1StatusesBody mediaIds(List<String> mediaIds) {
    this.mediaIds = mediaIds;
    return this;
  }

  public V1StatusesBody addMediaIdsItem(String mediaIdsItem) {
  ...
  **/
  ...
  public V1StatusesBody inReplyToId(String inReplyToId) {
  ...
  **/
  ...
  public V1StatusesBody sensitive(Boolean sensitive) {
  ...
  **/
  ...
  public V1StatusesBody spoilerText(String spoilerText) {
  ...
  **/
  ...
  public V1StatusesBody visibility(String visibility) {
  ...
  **/
  ...
  public V1StatusesBody scheduledAt(String scheduledAt) {
  ...
  **/
  ...
  public V1StatusesBody language(String language) {
  ...
  **/
  ...
  public V1StatusesBody format(String format) {
    this.format = format;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1StatusesBody v1StatusesBody = (V1StatusesBody) o;
    return Objects.equals(this.status, v1StatusesBody.status) &&
        Objects.equals(this.mediaIds, v1StatusesBody.mediaIds) &&
        Objects.equals(this.inReplyToId, v1StatusesBody.inReplyToId) &&
        Objects.equals(this.sensitive, v1StatusesBody.sensitive) &&
        Objects.equals(this.spoilerText, v1StatusesBody.spoilerText) &&
        Objects.equals(this.visibility, v1StatusesBody.visibility) &&
        Objects.equals(this.scheduledAt, v1StatusesBody.scheduledAt) &&
        Objects.equals(this.language, v1StatusesBody.language) &&
        Objects.equals(this.format, v1StatusesBody.format);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1StatusesBody {\n");
